const en = {
    ...
    bindEmail: 'Register Email',
    bind: 'Bind',
    bindEmailTip: 'Please register and bind an email',
    trustLevel: 'Level',
    exportEmails: 'Export Emails',
    exportEmailsDesc: 'Download all your emails as a single .mbox file (body only, attachments not included).',
    exportEmailsBtn: 'Export (.mbox)',
    exportFailMsg: 'Export failed',
